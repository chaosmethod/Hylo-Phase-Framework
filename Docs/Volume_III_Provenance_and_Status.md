...
- `README.md` *(public repository front page and reading guide)*

## 1.2 Current presentation master volume
- `Volume_I_Foundations.md`

## 1.3 Current microscopic-legality and executable-development authority
- `Volume_II_Microscopic_Derivation.md`
...
## 8.3 Stochastic jitter falsifier candidate note

`HPF_Stochastic_Jitter_Falsifier_Candidate_Note.md` is a separate candidate phenomenology note. It does not alter the active \(\Lambda\)/dark-matter derivation chain. Its current role is to define an external falsifier lane tied to finite scheduler discreteness and the vacuum scale \(L_{vac}\), with propagation-induced arrival-time broadening as the target observable.
...
5. `Volume_IV_Lambda_and_Dark_Matter.md`
6. `Symbol_Index.md`
7. `HPF_Stochastic_Jitter_Falsifier_Candidate_Note.md`
8. `Existence_Sensor_Protocol.md`
9. `Governor_Transfer_Theorem.md`
10. `qprca.py`
...
- \(b^3/(2\phi-1)^2\): leading surviving geometric correction in the active theorem spine
- \(b^1\) exclusion: structurally closed, awaiting explicit axiomatization of the state-space ceiling rule
- denominator uniqueness: conditionally closed under the Principle of Return-Class Capacity

This note advances the collapse correction from a loose candidate block to the current theorem-track reference for Volume IV, while `HPF_Development_History-4.md` remains the provenance support file for how that upgrade was reached.

## 8.5 Closure-stack correction reflection
...
These corrections are status-map material. They do not change the active \(\Lambda\) / dark-matter derivation chain.

# 10. Additional live supporting references

11. `HPF_Development_History-4.md`
12. `Delta_Collapse_Theorem_Note_v7U.md`
13. `HPF_Correction_Note_Bcap_and_ChiGeom.md`
