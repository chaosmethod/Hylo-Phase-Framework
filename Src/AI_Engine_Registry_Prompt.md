...
### FM-13 Dimensional Overreach
A theory claims more than three physical spatial dimensions in emergent geometry, or treats higher-dimensional mode spaces, topological classifications, or state spaces as extra physical directions rather than descriptive structure on a 3D forged substrate. Primary cases: literal extra spatial dimensions in string-theoretic, Kaluza-Klein, or brane-world proposals; treatment of internal symmetry indices or topological labels as physical spatial coordinates; emergent geometry constructions that require more than three spatial dimensions to close.
