#!/usr/bin/env python3
"""
Repo-facing wrapper for the canonical March 20 QPRCA executable reference.

The wrapped filename retains historical "MicroToy" wording for compatibility,
but the active repo status after the 2026-04-09 milestone is that the 4-bit
site alphabet is the candidate-locked fundamental operator grammar of the
substrate rather than provisional toy scaffolding.
"""
...
ORIG_PATH = Path(__file__).with_name("HPF_QPRCA_MicroToy_v0_2_7_BridgedContinuationAmbiguity_2026-03-20.py")  # historical filename retained for compatibility
