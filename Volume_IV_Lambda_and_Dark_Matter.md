...
k=11.
   ...
   Fixing midpoint (1.05), onset target (S\_\\ast=1.3806), and residual Einstein-side stability (\\eta=0.021) gives

   \[
k=\\frac{\\ln!\\left(\\frac{1-\\eta}{\\eta}\\right)}{S\_\\ast-1.05}\\approx 11.62.
]
